import { Code, Container, theme } from "@chakra-ui/react";
    ...
    >
        ...
        data={[
          {
            ...
            time: "1.2",
            commitHash: "a4cd810b2304189b453a44efc87b43745407a382",
          },
        ]}
        caption={
      ...
      <AccordionParagraph
        children={{
          "lsb_release -a": (
            <Code>
              Distributor ID: Ubuntu Description: Ubuntu 22.04.3 LTS Release:

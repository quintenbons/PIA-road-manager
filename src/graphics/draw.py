...
def draw_car(movable: Movable, screen: pygame.Surface, color: int, engine_x_min, engine_x_max, engine_y_min, engine_y_max, screen_width, screen_height, scale_factor):
